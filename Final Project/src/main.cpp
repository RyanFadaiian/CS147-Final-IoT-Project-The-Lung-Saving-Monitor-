...
// ----------------------------
#define SAS_TOKEN "SharedAccessSignature sr=cs147IotHub47.azure-devices.net%2Fdevices%2F147esp32&sig=jUkCFrSrvZCVn8WwXaSJGcoiZoVMsJUBAVVufY5XfQE%3D&se=1765607676"
...
void loop() {
    if (millis() - lastTelemetryTime >= TELEMETRY_INTERVAL) {
        ...
        if (pmOK) {
            ...
            // Normalize to real-world units (approx µg/m³)
            float n1  = pm1  / SCALE;
